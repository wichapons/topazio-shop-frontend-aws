              ...
              <Row className="mt-3">
                <Form onSubmit={sendReviewHandler}>
                  ...
                  >
                    ...
                    <Form.Control name="comment" required as="textarea" rows={3} disabled={!userInfo.name} />
                  </Form.Group>
                  ...
                  <Button disabled={!userInfo.name} type="submit" className="mt-3" variant="primary">
                    Submit 
                  </Button>
                  {productReviewed}
                </Form>
